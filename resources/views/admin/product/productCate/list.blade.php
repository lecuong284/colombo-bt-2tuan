...
@section('content')
    ...
    $list_config[] = array('title'=>'Ordering','field'=>'order','ordering'=> 1, 'type'=>'editText','arr_params'=>array('size'=>2));
    ...
    {!! genarateFormLiting($link = route('admin.cate.task'),$prefix = 'productCate' , $list, $fitler_config, $list_config, @$sort_field, @$sort_direct, $list->links()) !!}
@endsection