...
@section('content')
{!! formBegin(route('admin.cate.task')) !!}

{!! dtEditText($label = 'Category Name', $sizeLabel = 2, $name = 'name',$value = @$data -> name, $type = 'text', $sizeInput = 6, $placeholder = 'Nhập tên danh mục', $rowsTextarea = 0, $commet = 'Bạn cần nhập tên danh mục', $sizeComment = 4, $editor = 0) !!}
...
{!! dtEditText($label = 'Category Order', $sizeLabel = 2, $name = 'order',$value = @$data -> order, $type = 'text', $sizeInput = 6, $placeholder = 'Nhập thứ tự danh mục', $rowsTextarea = 0, $commet = 'Bạn cần nhập tên danh mục', $sizeComment = 0, $editor = 0) !!}
