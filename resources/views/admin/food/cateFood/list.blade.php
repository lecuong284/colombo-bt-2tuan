...
@section('content')
    ...
    {!! genarateFormLiting($link = 'admin.cateFood.task', $link_edit = 'admin.cateFood.getEditCate', $prefix = 'cateFood' , $list, $fitler_config, $list_config, @$sort_field, @$sort_direct, $list->links()) !!}
@endsection