...
{!! dtEditText($label = 'Order', $sizeLabel = 2, $name = 'ordering',$value = @$data -> ordering, $type = 'text', $sizeInput = 6, $placeholder = 'Nhập thứ tự', $rowsTextarea = 0, $commet = 'Bạn cần nhập tên danh mục', $sizeComment = 0, $editor = 0) !!}

{!! dtEditSelectbox($label = 'Category', $sizeLabel = 2, $name = 'cate_id', $value = @$data->cate_id, $widthSelect = 6, $heightSelect = 10, $array_select = @$cates, $field_value = 'id', $field_label = 'treename', $sizeHeight = 0, $multi = 0, $add_fisrt_option = 1, $comment = '', $sizeComment = 0) !!}
